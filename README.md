...
- **Code panes**: script previews, command previews, YAML fields and the Displays details template are CodeMirror editors — syntax highlighting for shell, PowerShell and YAML, folding, and undo/redo, themed to match whatever theme is active.
